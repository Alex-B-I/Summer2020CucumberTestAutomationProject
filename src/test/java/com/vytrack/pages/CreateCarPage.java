...
public class CreateCarPage extends BasePage {
    ...
    private WebElement createCareBtn;
    ...
    public void clickOnCreateCar(){
        ...
        wait.until(ExpectedConditions.elementToBeClickable(createCareBtn)).click();
        System.out.println("Clicking on 'Create car' button");
    }

    public void enterLicensePlate(String licencePlate){
      /*
        WebDriverWait wait = new WebDriverWait(Driver.getDriver(),20);
